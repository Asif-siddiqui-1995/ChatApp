...
export default function VideoRoom({open, handleClose}) {
    ...
    return (
        <div
            className={`fixed left-0 top-0 z-999999 flex h-full min-h-screen w-full items-center justify-center bg-black/90
    px-4 py-5 ${open ? "block" : "hidden"}`}
        >
            <div className="w-full max-w-142.5 rounded-lg bg-white dark:bg-boxdark md:py-8 px-8 py-12">
                <div className="flex flex-col space-y-6 ">
                    ...
                    <div className="grid grid-cols-2 gap-4 h-50 mb-4">
                        ...
                        {/* Video Feed 2 */}
                        <div className="relative h-full w-full dark:bg-boxdark-2 bg-gray rounded-md flex items-center justify-center">
                            <div className="space-y-2">
                                <img
                                    src={User02}
                                    alt=""
