...
export default function Document({incoming, author, timestamp, read_recipt}) {
    return incoming ? (
        <div className="max-w-125 w-fit">
            ...
            <div className="mb-2.5 rounded-2xl rounded-tl-none bg-gray px-5 py-3 dark:bg-boxdark-2 space-y-2">
                <div className="flex flex-grow items-center justify-between p-2 bg-gray-3 rounded-md dark:bg-bodydark">
                    <div className="flex flex-row items-center space-x-3">
                        <div className="p-2 rounded-md bg-primary/80 text-white">
                            <File size={20} />
                        </div>
                        <div className="flex flex-col">
                            <div>admin_v1.o.zip</div>
                ...
                <p>Dummy text Associated with this message</p>
            </div>
        ...
        <div className="max-w-125 w-fit ml-auto">
            <div className="mb-2.5 rounded-2xl rounded-br-none bg-primary px-5 py-3 text-white space-y-2">
                <div className="flex flex-grow items-center justify-between p-2 bg-white rounded-md text-primary">
                    <div className="flex flex-row items-center space-x-3">
