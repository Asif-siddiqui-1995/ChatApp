        ...
        <div className="flex flex-col w-full p-4 space-y-6">
            ...
            <div className="relative z-30 w-full rounded-full p-1 backdrop:blur sm:max-w-36 sm:p-3">
                <div className="relative drop-shadow-2 ">
                    ...
                    <label
                        htmlFor="profile"
                        className="absolute bottom-0 right-0 p-1 flex items-center justify-center rounded-full bg-primary text-white hover:bg-opacity-90 sm:bottom-2 sm:right-2"
                    >
                        <Camera size={20} />
                        <input
                            type="file"
                ...
                <form action="">
                    <div className="flex flex-col gap-5.5 p-6.5 ">
                        ...
                        <div>
                            ...
                            border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default
