...
export default function UserInfo({handleToggleUserInfo}) {
    return (
        <div className="border-l flex flex-col h-full border-stroke dark:border-x-strokedark">
            ...
            <div className="px-6 my-6">
                ...
                <div className="px-1 flex flex-row space-x-2 mt-5">
                    <button className="w-full border flex border-stroke dark:border-strokedark p-2 rounded-md flex-row items-center justify-center">
                    ...
                    <button className="border border-stroke dark:border-strokedark p-2 rounded-md flex-row items-center justify-center">
